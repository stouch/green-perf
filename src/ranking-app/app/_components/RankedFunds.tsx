    ...
    <div className="w-full overflow-x-auto md:overflow-x-hidden">
      <div className="min-w-[920px]">
        <div>
          <p>
            <span>
              <strong>Mise à jour 2024-09-07</strong> : L'accès au cours des
              fonds via les API Yahoo est actuellement bloqué :
            </span>
            &nbsp;
            <a
              href="https://github.com/gadicc/node-yahoo-finance2/issues/795"
              className="underline"
            >
              https://github.com/gadicc/node-yahoo-finance2/issues/795
            </a>
          </p>
          <p>J'essaie de corriger cela dès que possible.</p>
        </div>
        {false && (
          <>
            <div className="flex flex-row gap-3 my-4 pb-4 text-sm text-gray-700 dark:text-gray-300 border-b-1 border-b-gray-400 dark:border-b-gray-700">
              ...
              <div
                className={wPerCol[5]}
                onClick={() => setSortKey(SortKey.SIX_M)}
              >
                6 mois{sortKey === SortKey.SIX_M ? " ▲" : ""}
              </div>
              <div
                className={wPerCol[6]}
                onClick={() => setSortKey(SortKey.ONE_Y)}
              >
                1 an{sortKey === SortKey.ONE_Y ? " ▲" : ""}
              </div>
              <div
                className={wPerCol[7]}
                onClick={() => setSortKey(SortKey.TWO_Y)}
              >
            ...
            {rankedData.map((summary, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <div
                    className={`${wPerCol[5]} flex flex-row gap-2 items-center`}
                  >
                    {sixMonthDelta !== null && (
                      <RankingMetric
